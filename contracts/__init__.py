"""Normative structural contracts for Fandea (ADR-0009: contracts as code).
...
This package intentionally exists ahead of ``src/fandea/`` (see the repository status in
...
implementation. When ``src/fandea/`` is scaffolded at M0, it imports from here rather than
