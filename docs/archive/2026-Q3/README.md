...
Original stub paths under `docs/` were removed after a grace period; all links now point here.

| File | Original role |
| --- | --- |
| `archive/2026-Q3/implementation-plan.md` | M0–M9 build order (CI still parses this copy) |
| `implementation-plan-*.md` | Feature-specific build plans |
| `archive/2026-Q3/refactor-plan.md` | Pre-M0 design blockers B1–B7 / R0–R5 |
| `archive/2026-Q3/principal-review-2026-08.md` | External architecture review snapshot |
...
archive commits on `main`). Prefer `git show <pre-archive-sha>:docs/archive/2026-Q3/implementation-plan.md` (etc.)
